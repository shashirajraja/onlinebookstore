...
### About
A userfriendly Online Bookstore System project where users can login or register, view the available books, select books along with their quantity, and buy them. User can also get a payment receipt after sucessful payment. The proejct can also be used by the administrator, who can add new books, remove books, increase and decrease the quantity of books, change the price of the books as well as maintain the selling history of books.
