    ...
    agent any  
		...
		stage("Docker Image Build"){
			steps{
				...
				sh "docker image tag $Demoapplication:V1.$BUILD_ID anilphugare1/$JOB_NAME:V1.$BUILD_ID"
				sh "docker image tag $Demoapplication:V1.$BUILD_ID anilphugare1/$JOB_NAME:V1.$latest"
				}
			}
		}
